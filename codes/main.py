...
def object_detection_video():
    ...
    if uploaded_video != None:
        ...
        out = cv2.VideoWriter("detect_video.mp4", fourcc, 20.0, (w, h))
        count = 0
        while True:
            _, image = cap.read()
            if _ != False:
...
def main():
    ...
    if choice == "Object Detection(Image)":
        ...
        clip = moviepy.VideoFileClip("detect_video.mp4")
        ...
        read_me_0.empty()
        read_me.empty()
        github_gist('https://gist.github.com/zhoroh/8c4e63fe08904a0838a7d8b7edd72b2d')
