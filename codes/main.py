...
def object_detection_video():
    ...
    if uploaded_video != None:
        ...
        out = cv2.VideoWriter(r"detected_video.mp4", fourcc, 20.0, (w, h))
        count = 0
        while True:
            _, image = cap.read()
            if _ != False:
...
def main():
    ...
    if choice == "Object Detection(Image)":
        ...
        read_me_0.empty()
        read_me.empty()
        var = object_detection_video()
        clip = moviepy.VideoFileClip(var)
        ...
        read_me_0.empty()
        read_me.empty()
        github_gist('https://gist.github.com/zhoroh/1909426b19d2014681b8e262a39328a6')
