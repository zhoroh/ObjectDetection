...
def object_detection_video():
    ...
    SCORE_THRESHOLD = 0.5
    IOU_THRESHOLD = 0.5
    config_path = r'C:\Users\Olazaah\Downloads\stream\config_n_weights\yolov3.cfg'
    weights_path = r'C:\Users\Olazaah\Downloads\stream\config_n_weights\yolov3.weights'
    font_scale = 1
    thickness = 1
    ...
    if uploaded_video != None:
        ...
        out = cv2.VideoWriter(r"C:\Users\Olazaah\Downloads\stream\Gallery\detectedVideos\detected_{}".format(name), fourcc, 20.0, (w, h))
        count = 0
        while True:
            _, image = cap.read()
            if _ != False:
